...
config :tasker, TaskerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "0ouSLPODSXUUiF3pJjEPDK4hn1IToyV5yOFGJt17EapSpdF2K0gRZR9NRevyDOtm",
  watchers: [
...
config :tasker, TaskerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/tasker_web/router\.ex$"E,
      ~r"lib/tasker_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
